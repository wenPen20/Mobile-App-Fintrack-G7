...
String formatDayHeader(DateTime date) => DateFormat('EEEE, d MMMM').format(date);
...
/// "Today" / "Yesterday" / else "12 June" — the label on the Add/Edit date box.
/// We compare DATE-ONLY (time stripped to midnight) so two times on the same
/// calendar day count as equal.
