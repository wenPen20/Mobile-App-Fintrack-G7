...
//    NO `account` tag (TnG / Bank / Wise) and NO category icon/colour.
...
class TransactionUi {
  ...
  final String account; // e.g. "TnG GO+", "Wise USD", "Bank"
  ...
  final DateTime
  dateTime; // full date AND time (we show both: day header + HH:mm)
